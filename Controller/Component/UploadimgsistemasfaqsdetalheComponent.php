...
/**
 * Uploadimgsistemasfaqsdetalhe component
 */
class UploadimgsistemasfaqsdetalheComponent extends Component
{
    public $max_files = 3;
	...
	public function upload($data,$galeria) 
	{
		...
		return $this->_registry->getController()->redirect(['controller' => 'Sistemasfaqsdetalhes','action' => 'addid',$galeria]);
		...
		foreach ($data as $file) 
		{
			...
			$dir = WWW_ROOT.'img'.DS.'sistemasfaqsdetalhes'.DS.$galeria;
            //var_dump($dir);
			...
			$type_allowed = array('PNG','png','jpg','jpeg','gif','pptx','xls','xlsx','pdf','doc','docx','sql','prc','zip');
					...
					//->original:	return $this->_registry->getController()->redirect(['action'=>'add');
						...
						return $this->_registry->getController()->redirect(['controller' => 'Sistemasfaqsdetalhes','action' => 'add',$galeria]);
					...
					elseif (is_uploaded_file($file_tmp_name)) 
					{
								...
								$file_db = TableRegistry::get('sistemasfaqsdetalhesimgs');
								...
								$entity->sistemasfaqsdetalhe_id = $galeria;
								$file_db->save($entity);
					...
					return $this->_registry->getController()->redirect(['controller'=>'Sistemasfaqsdetalhes','action' => 'view',$galeria]);	
					}
