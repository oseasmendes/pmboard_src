...
class ProjetossprintsretrosactionsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Projetossprintsretrositems', 'Consultores', 'Pillars', 'Pillarsareas', 'Pillarsresponsabilities']
        ];
    ...
    public function add($id = null)
    {
        ...
        $this->set(compact('projetossprintsretrosaction', 'projetossprintsretrositems', 'consultores', 'pillars', 'pillarsareas', 'pillarsresponsabilities'));
    }
