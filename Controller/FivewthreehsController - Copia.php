...
class FivewthreehsController extends AppController
{
    ...
    public function add()
    {
        ...
        $sistemas = $this->Fivewthreehs->Sistemas->find('list',array('conditions'=>array('Sistemas.statusfuncional_id'=> '5'),'order' => array('Codinome' => 'asc')),['limit' => 200]);

        $this->set(compact('fivewthreeh', 'programas', 'projetos', 'projetosprodutos', 'participantes', 'statusfuncionals', 'consultores', 'atas', 'empresas','fivewthreehstypes','eventos'));
    }
