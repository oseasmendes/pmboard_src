...
class TodoseventosController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Todos', 'Tecnicos', 'Consultores']
        ];
    ...
    public function add()
    {
        ...
        $consultores = $this->Todoseventos->Consultores->find('list', ['limit' => 200]);
        $this->set(compact('todosevento', 'todos', 'consultores'));
    }
