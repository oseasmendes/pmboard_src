...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $projetossprintsitem->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $projetossprintsitem->id)]
            )
        ?></li>
...
<div class="projetossprintsitems form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Projetossprintsitem') ?></legend>
        <?php
            ...
            echo $this->Form->control('canceladoem', ['empty' => true]);
            echo $this->Form->control('canceladomotivo', ['empty' => true]);
        ?>
    </fieldset>
