...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $sistemasqueuesconsultore->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $sistemasqueuesconsultore->id)]
            )
        ?></li>
...
<div class="sistemasqueuesconsultores form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Sistemasqueuesconsultore') ?></legend>
        <?php
