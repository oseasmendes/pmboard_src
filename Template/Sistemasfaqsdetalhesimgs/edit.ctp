...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $sistemasfaqsdetalhesimg->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $sistemasfaqsdetalhesimg->id)]
            )
        ?></li>
...
<div class="sistemasfaqsdetalhesimgs form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Sistemasfaqsdetalhesimg') ?></legend>
        <?php
