 ...
 * @var \App\Model\Entity\Knowhow[]|\Cake\Collection\CollectionInterface $knowhows
 */
?>
...
<div class="knowhows index large-9 medium-8 columns content">
    <h3><?= __('Knowhows') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $knowhow->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $knowhow->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $knowhow->id], ['confirm' => __('Are you sure you want to delete # {0}?', $knowhow->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
