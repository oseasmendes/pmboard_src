...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $sistemasbriefing->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $sistemasbriefing->id)]
            )
        ?></li>
...
<div class="sistemasbriefings form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Sistemasbriefing') ?></legend>
        <?php
            echo $this->Form->control('sistema_id', ['options' => $sistemas]);
