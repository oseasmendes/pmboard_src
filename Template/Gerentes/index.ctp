 ...
 * @var \App\Model\Entity\Gerente[]|\Cake\Collection\CollectionInterface $gerentes
 */
?>
...
<div class="gerentes index large-9 medium-8 columns content">
    <h3><?= __('Gerentes') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $gerente->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $gerente->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $gerente->id], ['confirm' => __('Are you sure you want to delete # {0}?', $gerente->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
