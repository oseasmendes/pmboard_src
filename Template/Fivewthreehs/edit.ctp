...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $fivewthreeh->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $fivewthreeh->id)]
            )
        ?></li>
...
<div class="fivewthreehs form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Fivewthreeh') ?></legend>
        <?php
            ...
            echo $this->Form->control('wwhen',['class'=> "form-control"],['empty' => true]);
            ...
            echo $this->Form->control('acao',['class'=> "form-control"]);
            echo $this->Form->control('resolvido', ['empty' => true]);
            echo $this->Form->control('ata_id', ['options' => $atas ,'class'=>['class'=> 'form-control'] , 'empty' => true]);
