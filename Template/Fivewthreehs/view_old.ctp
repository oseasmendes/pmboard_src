...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Fivewthreeh'), ['action' => 'edit', $fivewthreeh->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Fivewthreeh'), ['action' => 'delete', $fivewthreeh->id], ['confirm' => __('Are you sure you want to delete # {0}?', $fivewthreeh->id)]) ?> </li>
...
<div class="fivewthreehs view large-9 medium-8 columns content">
    <h3><?= h($fivewthreeh->description) ?></h3>
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Fivewthreehstype') ?></th>
            <td><?= $fivewthreeh->has('fivewthreehstype') ? $this->Html->link($fivewthreeh->fivewthreehstype->descricao, ['controller' => 'Fivewthreehstypes', 'action' => 'view', $fivewthreeh->fivewthreehstype->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $this->Number->format($fivewthreeh->evento_id) ?></td>
        </tr>
        <tr>
