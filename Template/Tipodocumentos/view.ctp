...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Tipodocumento'), ['action' => 'edit', $tipodocumento->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Tipodocumento'), ['action' => 'delete', $tipodocumento->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tipodocumento->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Tipodocumentos'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Tipodocumento'), ['action' => 'add']) ?> </li>
...
<div class="tipodocumentos view large-9 medium-8 columns content">
    ...
    <div class="related">
        ...
        <?php if (!empty($tipodocumento->atas)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th scope="col"><?= __('Condicao Id') ?></th>
            ...
            <?php foreach ($tipodocumento->atas as $atas): ?>
            <tr>
                <td><?= h($atas->id) ?></td>
