...
<div class="projetosprodutosreqs form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo '<div class="col">';         
			echo $this->Form->control('projetosproduto_id', array('default'=>$paramid,'disabled' => 'disabled','value'=>$paramid,'class'=>['class'=> 'form-control'])); //inserido esse parametro para receber projeto_id			
			echo '</div>';  
            echo '</div>';    
            echo '</p>';    
            echo '<div class="form-row">';
            ...
            echo '</div>';
            echo '<div class="col">';    
            echo $this->Form->control('reqstatus', ['options' => ['TECH_EVALU'=>'TECH_EVALU','BUSIN_EVALU'=>'BUSIN_EVALU','APPROVED'=>'APPROVED','DELIVERED'=>'DELIVERED','CANCELLED'=>'CANCELLED','IN_REVISION'=>'IN_REVISION','CHANGED'=>'CHANGED','DEFINED'=>'DEFINED'],'class'=>['class'=> 'form-control'] , 'empty' => true]);
            echo '</div>';
            echo '</div>';     
            echo '</p>';   
        ?>
