 ...
 * @var \App\Model\Entity\Projetosprodutosriscosreco[]|\Cake\Collection\CollectionInterface $projetosprodutosriscosrecos
 */
?>
...
<div class="projetosprodutosriscosrecos index large-9 medium-8 columns content">
    <h3><?= __('Projetosprodutosriscosrecos') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($projetosprodutosriscosrecos as $projetosprodutosriscosreco): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $projetosprodutosriscosreco->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $projetosprodutosriscosreco->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $projetosprodutosriscosreco->id], ['confirm' => __('Are you sure you want to delete # {0}?', $projetosprodutosriscosreco->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
