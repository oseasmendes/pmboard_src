...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ata->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ata->id)]
            )
        ?></li>
...
<div class="atas form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Ata') ?></legend>
        <?php
            echo $this->Form->control('dataemissao', ['empty' => true]);
            echo $this->Form->control('datareuniao', ['empty' => true]);
            echo $this->Form->control('agenda_id', ['options' => $agendas, 'empty' => true,'class'=>['class'=> 'form-control']]);
            ...
            echo $this->Form->control('proximadatareuniao', ['class'=> "form-control"]);
