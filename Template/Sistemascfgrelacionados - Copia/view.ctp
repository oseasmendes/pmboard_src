...
<div class="sistemascfgrelacionados view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $this->Number->format($sistemascfgrelacionado->sistemarelacionado_id) ?></td>
            <td><?= $sistemascfgrelacionado->has('sistema') ? $this->Html->link($sistemascfgrelacionado->sistema->descricao, ['controller' => 'Sistemas', 'action' => 'view', $sistemascfgrelacionado->sistema->sistemarelacionado_id]) : '' ?></td>
        </tr>
        <tr>
