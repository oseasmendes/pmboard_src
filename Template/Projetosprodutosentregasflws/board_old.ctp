           ...
           <!-- <tr>
            ...
            <?php 
                if ($x == 1) { 
                        ...
                        $card1[1] = strtoupper(h($projeto->codenome));
                        ...
                        echo '<h6 class="card-title"><p class="font-weight-bold text-secondary">'.$card1[0].'</p></h6>';
                    ...
                    //    echo $this->Form->postLink(__('Delete'), ['action' => 'delete', $projeto->id], ['confirm' => __('Are you sure you want to delete # {0}?', $projeto->id)]) ;
                        ...
                        echo '</div>';                        
                            ...
                            $card2[1] = strtoupper(h($projeto->codenome)); 
                            $card2[2] = h($projeto->realizadodatainicio);
                            $card2[3] = $projeto->has('statusfuncional') ? $projeto->statusfuncional->descricao : '';
                        //     var_dump($card2);   
                            $x = $x + 1;
                            echo '<div class="card bg-light mb-3" style="width: 18rem;">';
                            echo '<img class="card-img-top" src="/img/pmboard_blue.png" alt="PmBoard logo">';
                            echo '<div class="card-body">';
                            echo '<h6 class="card-title"><p class="font-weight-bold text-secondary">'.$card2[0].'</p></h6>';
                           // echo '<h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6>';
                            ...
                            echo '<p class="card-text">Início: '.$card2[2].'</p>';
                            echo '<p class="card-text">Status: '.$card2[3].'</p>';
                           // echo '<a href="#" class="card-link">Card link</a>';
                           // echo '<a href="#" class="card-link">Another link</a>';
                            echo '<td class="actions">';
                            echo $this->Html->link(__('View'), ['action' => 'view', $projeto->id], array('class' => 'btn btn-info')); 
                            ...
                            echo '</div>';
                                ...
                                $card3[1] = strtoupper(h($projeto->codenome)); 
                                $card3[2] = h($projeto->realizadodatainicio);
                                $card3[3] = $projeto->has('statusfuncional') ? $projeto->statusfuncional->descricao : '';
                          //      var_dump($card3);    
                                //$x = 1;
                                $x = $x + 1;
                                echo '<div class="card bg-light mb-3" style="width: 18rem;">';
                                echo '<img class="card-img-top" src="/img/pmboard_blue.png" alt="PmBoard logo">';
                                echo '<div class="card-body">';
                                echo '<h6 class="card-title"><p class="font-weight-bold text-secondary">'.$card3[0].'</p></h6>';
                                //echo '<h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6>';
                                echo '<h5 class="card-subtitle mb-2 text-muted"><p class="font-weight-bold text-primary" >'.$card3[1].'</p></h5>';
                                echo '<p class="card-text">Início: '.$card3[2].'</p>';
                                echo '<p class="card-text">Status: '.$card3[3].'</p>';
                                //echo '<a href="#" class="card-link">Card link</a>';
                                //echo '<a href="#" class="card-link">Another link</a>';
                                 echo '<td class="actions">';
                                echo $this->Html->link(__('View'), ['action' => 'view', $projeto->id], array('class' => 'btn btn-info')); 
                                ...
                                $card4[1] = strtoupper(h($projeto->codenome)); 
                                $card4[2] = h($projeto->realizadodatainicio);
                                $card4[3] = $projeto->has('statusfuncional') ? $projeto->statusfuncional->descricao : '';
                          //      var_dump($card3);    
                                $x = 1;
                                //$x = $x + 1;
                                echo '<div class="card bg-light mb-3" style="width: 18rem;">';
                                echo '<img class="card-img-top" src="/img/pmboard_blue.png" alt="PmBoard logo">';
                                echo '<div class="card-body">';
                                echo '<h6 class="card-title"><p class="font-weight-bold text-secondary">'.$card4[0].'</p></h6>';
                                //echo '<h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6>';
                                echo '<h5 class="card-subtitle mb-2 text-muted"><p class="font-weight-bold text-primary" >'.$card4[1].'</p></h5>';
                                echo '<p class="card-text">Início: '.$card4[2].'</p>';
                                echo '<p class="card-text">Status: '.$card4[3].'</p>';
                                //echo '<a href="#" class="card-link">Card link</a>';
                                //echo '<a href="#" class="card-link">Another link</a>';
                                 echo '<td class="actions">';
                                echo $this->Html->link(__('View'), ['action' => 'view', $projeto->id], array('class' => 'btn btn-info')); 
