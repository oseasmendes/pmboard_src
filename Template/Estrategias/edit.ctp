...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $estrategia->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $estrategia->id)]
            )
        ?></li>
...
<div class="estrategias form large-9 medium-8 columns content">
    <?= $this->Form->create($estrategia) ?>
    <fieldset>
        <legend><?= __('Edit Estrategia') ?></legend>
        <?php
