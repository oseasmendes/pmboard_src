...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Pillar'), ['action' => 'edit', $pillar->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Pillar'), ['action' => 'delete', $pillar->id], ['confirm' => __('Are you sure you want to delete # {0}?', $pillar->id)]) ?> </li>
...
<div class="pillars view large-9 medium-8 columns content">
    <h3><?= h($pillar->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($pillar->projetossprintsretrosactions)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($pillar->projetossprintsretrosactions as $projetossprintsretrosactions): ?>
            <tr>
