...
<div class="projetos view large-9 medium-8 columns content">
    ...
    <!-- <table class="vertical-table"> -->
        ...
        <tr>
            <th scope="row"><?= __('Lead Time Unit') ?></th>            
            <td><?= h($projeto->leadtimeunitexpected) ?></td>
            <th scope="row"><?= __('Lead Time') ?></th>            
            <td><?= h($projeto->leadtimeexpected) ?></td>
            <th scope="row"><?= __('Technical Unit Lead Time') ?></th>            
            <td><?= h($projeto->technicalunitleadtime) ?></td>
            <th scope="row"><?= __('Technical Lead Time') ?></th>            
            <td><?= h($projeto->technicalleadtime) ?></td>                       
        </tr>    
        <tr>
            <th scope="row"><?= __('Analisys Unit Lead Time') ?></th>            
            <td><?= h($projeto->analysisunitleadtime) ?></td>
            <th scope="row"><?= __('Analisys Lead Time') ?></th>            
            <td><?= h($projeto->analysisleadtime) ?></td>
            <th scope="row"><?= __('Develop Unit Lead Time') ?></th>            
            <td><?= h($projeto->developunitleadtime) ?></td>
            <th scope="row"><?= __('Develop Lead Time') ?></th>            
            <td><?= h($projeto->developleadtime) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('User Unit Lead Time') ?></th>            
            <td><?= h($projeto->userunitleadtime) ?></td>
            <th scope="row"><?= __('User Lead Time') ?></th>            
            <td><?= h($projeto->userleadtime) ?></td>
        </tr>
    </table>
    <div class="row" > 
