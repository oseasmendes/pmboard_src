                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <?= $this->Html->link(__('List Programas'), ['controller' => 'Programas', 'action' => 'index'],['class'=>'dropdown-item'])?>
                                 <?= $this->Html->link(__('Board Project Notes'), ['controller' => 'Projetosnotas', 'action' => 'board'],['class'=>'dropdown-item'])?>
...
<!-- <div class="projetos index large-12 medium-8 columns content"> -->
      ...
      <!-- <table class="table table-striped table-dark table-responsive">  -->
        ...
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('previstodatafim') ?></th>              
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="row">    
                    <?= $this->Html->link(__('VIE'), ['action' => 'view', $projeto->id],['class'=>'btn btn-primary btn-sm']) ?>
                    <?= $this->Html->link(__('EDT'), ['action' => 'edit', $projeto->id],['class'=>'btn btn-success btn-sm']) ?>
                 <!--   <?= $this->Form->postLink(__('DEL'), ['action' => 'delete', $projeto->id],['class'=>'btn btn-secondary btn-sm'], ['confirm' => __('Are you sure you want to delete # {0}?', $projeto->id)]) ?>                    -->
                    </div>
                </td>
            </tr>
            <div class="card card-secondary">
                    <div class="card-header">
                        <h5 class="panel-title"><?= $this->Number->format($projeto->id)."-".h($projeto->codenome) ?></h5>
                    </div>
                    <div class="card-body">  
                        
                        <p class="card-text"><?= $projeto->has('programa') ? $this->Html->link($projeto->programa->descricao, ['controller' => 'Programas', 'action' => 'view', $projeto->programa->id]) : '' ?></p>                   
                        <?= $projeto->has('statusfuncional') ? $projeto->statusfuncional->descricao : '' ?>
