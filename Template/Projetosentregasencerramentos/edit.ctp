...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $projetosentregasencerramento->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $projetosentregasencerramento->id)]
            )
        ?></li>
...
<div class="projetosentregasencerramentos form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Projetosentregasencerramento') ?></legend>
        <?php
            echo $this->Form->control('projetosprodutosentrega_id', ['options' => $projetosprodutosentregas,'disabled' => 'disabled', 'empty' => true]);
