...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $projetossprintsdailysreference->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $projetossprintsdailysreference->id)]
            )
        ?></li>
...
<div class="projetossprintsdailysreferences form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Projetossprintsdailysreference') ?></legend>
        <?php
