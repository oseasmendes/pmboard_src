 ...
 *
 * @method \App\Model\Entity\Projetossprintsdaily get($primaryKey, $options = [])
 * @method \App\Model\Entity\Projetossprintsdaily newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Projetossprintsdaily[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Projetossprintsdaily|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Projetossprintsdaily saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Projetossprintsdaily patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Projetossprintsdaily[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\Projetossprintsdaily findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class ProjetossprintsdailysTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('projetossprintsdailys');
